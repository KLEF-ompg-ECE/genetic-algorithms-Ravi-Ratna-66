...
if __name__ == "__main__":
    ...
    save_plot(vl2a, "plots/experiment_2a.png", "mutation_rate=0.01")   # <- change filename
    ...
    save_plot(vl2b, "plots/experiment_2b.png", "mutation_rate=0.05")   # <- change filename
    ...
    save_plot(vl2c, "plots/experiment_2c.png", "mutation_rate=0.30")   # <- change filename
